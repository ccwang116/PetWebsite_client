...
function Coupon(props) {
  ...
  const activebutton={width:"120px",height:"44px",color:"#4E95A1",background:"#FFCC84",borderBottom:"2px solid #C5895A"}
  const normalbutton={width:"120px",height:"44px",color:"#4E95A1"}
  ...
  return (
    <>
      ...
      <MemberSideLink>
        ...
        <div style={{width:"100%",height:"44px",marginBottom:"32px",borderBottom:"2px solid #cccccc"}} >
